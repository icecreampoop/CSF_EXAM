...
public class PictureRepository {
	...
	private static String collectionName = "travelpics";
	...
	// TODO IMPORTANT: Write the native mongo query in the comments above this method
	public void save(PictureModel picture) {
		template.save(picture, collectionName);
	}
